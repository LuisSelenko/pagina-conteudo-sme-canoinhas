...
<body>
  <header>
    ...
    <div><h1>Conteúdos do 2º ano</h1></div>
    <div id="content-back">
    ...
    <div class="content">
      ...
      <div class="card">
        ...
        <div class="card-content">
          <?php
            $path = "files/Iniciais/2 ano/Lingua Portuguesa/";
      ...
      <div class="card">
        ...
        <div class="card-content">
        <?php
          $path = "files/Iniciais/2 ano/Matematica/";
      ...
      <div class="card">
        ...
        <div class="card-content">
          <?php
            $path = "files/Iniciais/2 ano/Historia/";
       ...
       <div class="card">
        ...
        <div class="card-content">
          <?php
            $path = "files/Iniciais/2 ano/Geografia/";
       ...
       <div class="card">
        ...
        <div class="card-content">
          <?php
            $path = "files/Iniciais/2 ano/Ciencias/";
       ...
       <div class="card">
        ...
        <div class="card-content">
          <?php
            $path = "files/Iniciais/2 ano/Ensino Religioso/";
       ...
       <div class="card">
        ...
        <div class="card-content">
          <?php
            $path = "files/Iniciais/2 ano/Arte/";
       ...
       <div class="card">
        ...
        <div class="card-content">
          <?php
            $path = "files/Iniciais/2 ano/Educacao Fisica/";
