...
<body>
  <header>
    ...
    <div><h1>Conteúdos do 8º ano</h1></div>
    <div id="content-back">
    ...
    <div class="content">
      ...
      <div class="card">
        ...
        <div class="card-content">
          <?php
            $path = "files/Finais/8 ano/Lingua Portuguesa/";
      ...
      <div class="card">
        ...
        <div class="card-content">
        <?php
          $path = "files/Finais/8 ano/Matematica/";
      ...
      <div class="card">
        ...
        <div class="card-content">
          <?php
            $path = "files/Finais/8 ano/Historia/";
       ...
       <div class="card">
        ...
        <div class="card-content">
          <?php
            $path = "files/Finais/8 ano/Geografia/";
       ...
       <div class="card">
        ...
        <div class="card-content">
          <?php
            $path = "files/Finais/8 ano/Ciencias/";
       ...
       <div class="card">
        ...
        <div class="card-content">
          <?php
            $path = "files/Finais/8 ano/Ensino Religioso/";
       ...
       <div class="card">
        ...
        <div class="card-content">
          <?php
            $path = "files/Finais/8 ano/Educacao Fisica/";
